...
A competition's WCIF contains the full event schedule (all events, so caching one WCIF per competition is enough to
...
# Find every competition that has a relevant event
...
# Fetch + cache WCIF for each competition
